...
def Analyse(t,weighting):
    ...
    # Draw histograms
    # Format is t.Draw("[variable to plot] >> [histogram name] ([number of bins], [x axis minimum], [x axis maximum]"),weighting)
    ...
    meanPt = "Sum$(lep_pt)/Length$(lep_pt)" 
    t.Draw(meanPt + ">> h_lep_pt_mean(200,0,140e3)", weighting)
